...
rm -rf work
mkdir work
for i in Kernel FileDir Files Modules Fonts Input Display Viewers Texts Oberon MenuViewers TextFrames System Edit Graphics GraphicFrames Curves ORS ORB ORG ORP BootLoad SCC RS232; do
